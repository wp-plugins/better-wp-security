...
if ($send_email_backup) xmail($to_emailaddress,$from_emailaddress, "phpMySQLAutoBackup: $backup_file_name", $dump_buffer, $backup_file_name, $backup_type, $newline, $phpMySQLAutoBackup_version);
...
if (DEBUG) echo '<textarea cols=150 rows=50>'.$backup_info."\n\nERRORS: ".$errors.'</textarea>';
?>
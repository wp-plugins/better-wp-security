...
final class ITSEC_Logger {
	...
	public function add_admin_meta_boxes() {
		...
		add_meta_box(
			'itsec_log_header',
			__( 'Security Logs', 'ithemes-security' ),
		...
		add_meta_box(
			'itsec_log_all',
			__( 'All Logged Items', 'ithemes-security' ),
	...
	public function metabox_logs_header() {
		...
		printf(
			'<p>%s %s. %s</p>',
			__( 'Below are various logs of information collected by', 'ithemes-security' ),
			$itsec_globals['plugin_name'],
			__( 'This information can help you get a picture of what is happening with your site and the level of success you have achieved in your security efforts.', 'ithemes-security' )
		);
	...
	public function metabox_all_logs() {
		...
		echo __( 'Below is the log of all the log items in your WordPress Database. To adjust logging options visit the global settings page.', 'ithemes-security' );

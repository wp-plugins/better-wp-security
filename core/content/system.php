...
<li>
	...
	<ul>
		...
		if ( get_option( 'permalink_structure' ) != '' ) {
			...
			$copen               = '<font color="red">';
			$cclose              = '</font>';
			$permalink_structure = __( 'WARNING! Permalinks are NOT Enabled. Permalinks MUST be enabled for this plugin to function correctly', 'ithemes-security' );
		}
		?>
...
<li>
	<h4><?php echo $itsec_globals['plugin_name'] . __( ' variables', 'ithemes-security' ); ?></h4>
	<ul>
		<li><?php _e( 'Build Version', 'ithemes-security' ); ?>:
			<strong><?php echo $itsec_globals['plugin_build']; ?></strong><br/>
			<em><?php _e( 'Note: this is NOT the same as the version number on the plugin page or WordPress.org page and is instead used for support.', 'ithemes-security' ); ?></em>
		</li>
	</ul>
</li>
</ul>
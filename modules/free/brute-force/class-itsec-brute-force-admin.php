...
class ITSEC_Brute_Force_Admin {
	...
	public function add_admin_meta_boxes() {
		...
		$title = __( 'Brute Force Protection', 'ithemes-security' );
	...
	public function brute_force_check_period() {
		...
		$content .= '<label for="itsec_brute_force_check_period"> ' . __( 'Minutes', 'ithemes-security' ) . '</label>';
	...
	public function brute_force_enabled() {
		...
		$content .= '<label for="itsec_brute_force_enabled"> ' . __( 'Enable brute force protection.', 'ithemes-security' ) . '</label>';
	...
	public function brute_force_max_attempts_host() {
		...
		$content .= '<label for="itsec_brute_force_max_attempts_host"> ' . __( 'Attempts', 'ithemes-security' ) . '</label>';
	...
	public function brute_force_max_attempts_user() {
		...
		$content .= '<label for="itsec_brute_force_max_attempts_user"> ' . __( 'Attempts', 'ithemes-security' ) . '</label>';
	...
	public function dashboard_status( $statuses ) {
		...
		if ( $this->settings['enabled'] === true ) {
			...
			$status       = array( 'text' => __( 'Your login area is protected from brute force attacks.', 'ithemes-security' ), 'link' => '#itsec_brute_force_enabled', );

		} else {

			$status_array = 'high';
			$status       = array( 'text' => __( 'Your login area is not protected from brute force attacks.', 'ithemes-security' ), 'link' => '#itsec_brute_force_enabled', );
	...
	public function register_logger_metaboxes( $metaboxes ) {
		...
		if ( isset( $this->settings['enabled'] ) && $this->settings['enabled'] === true ) {
			...
			$metaboxes[] = array(
				'module'   => 'brute_force',
				'title'    => __( 'Invalid Login Attempts', 'ithemes-security' ),

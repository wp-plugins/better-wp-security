	...
	public function force_unique_nicename( &$errors, $update, &$user ) {
		...
		if ( ! empty( $user->nickname ) ) {
			...
			if ( $user->nickname == $user->user_login ) {
				...
				$errors->add( 'user_error', __( 'Your Nickname must be different than your login name. Please choose a different Nickname.', 'ithemes-security' ) );
			...
			$errors->add( 'user_error', __( 'A Nickname is required. Please choose a nickname or fill out your first and last name.', 'ithemes-security' ) );
